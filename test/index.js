...
cup.test('Tests will pass correctly', new Promise((resolve, reject) => {
...
cup.test('Tests will fail correctly', new Promise((resolve, reject) => {
...
cup.test('Tests will behave correctly', new Promise((resolve, reject) => {
...
cup.test('Tests will bail correctly', new Promise((resolve, reject) => {
...
cup.test('Tests skip correctly', new Promise((resolve, reject) => {
    const env = Object.create(process.env);
    env.CUP_ONLY = '1';
